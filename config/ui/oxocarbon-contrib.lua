...
vim.api.nvim_set_hl(0, "TelescopePreviewTitle", { fg = oxocarbon.base12, bg = oxocarbon.none, bold = true })
vim.api.nvim_set_hl(0, "TelescopePromptTitle", { fg = oxocarbon.base11, bg = oxocarbon.none, bold = true })
vim.api.nvim_set_hl(0, "TelescopeResultsTitle", { fg = oxocarbon.base14, bg = oxocarbon.none, bold = true })
